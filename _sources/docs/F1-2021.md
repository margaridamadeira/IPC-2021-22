...
---
[Retas de conversão de temperatura](https://pt.wikipedia.org/wiki/R%C3%A9aumu), Captura de imagem na página *Réaumur* da Wikipedia.org, CC-BY-SA 3.0, acedido a 2021-11-22.
```

Hoje vamos tratar de várias unidades de temperatura.
...
| Ebulição da água | 373.1339 K | 99.9839 °C | 211.97102 °F | 671.64102 °R|
